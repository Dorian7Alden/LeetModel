...
public interface ProblemFeignClient {
    ...
    @GetMapping("/internal/problems/{problemId}/context")
    Result<ProblemContextDTO> getProblemContext(@PathVariable Long problemId);
    ...
    @PostMapping("/internal/problems/assistant-query")
    Result<AssistantProblemResultDTO> queryForAssistant(@RequestBody AssistantProblemQueryDTO request);
}
