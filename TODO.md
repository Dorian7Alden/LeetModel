...
- 验收：知识工具、工具注册表和终止式编排共 17 项目标测试通过；独立 `PROMPT_ASSISTANT_KNOWLEDGE_0001` 与禁用工具的 `MODEL_CFG_ASSISTANT_KNOWLEDGE_0001` 已发布，NONE/FIXED_INDEX 快照、300 码点上限、回答哈希审计、越界固定回复和递归拒绝均有覆盖。
