...
### 五、Figma Auto Layout 结构树与工程资产

为方便在 Figma 设计工具中进行协作与后续迭代，本骨架已转化为原生矢量图层资产沉淀于：
- **文件路径**：`docs/project/04-前端设计/assets/home-skeleton-figma-ready.svg`
- **使用方式**：可直接拖入任意 Figma 设计文件，所有 `Frame` 容器、矩形槽位、间距与文字标线将自动还原为 Figma 原生分层图层。

#### Figma Frame 树状拓扑与参数映射

```text
Frame: LeetModel_Home_Desktop_1200 [W: 1200, H: 940, AutoLayout: Vertical, Gap: 20]
