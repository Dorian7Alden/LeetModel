...
> 设计状态：待用户确认。本文档是本轮管理端重构的目标依据；当前代码仍是 2026-08-30 至 2026-08-31 形成的已验收版本，不应把本文描述误认为已实现。
