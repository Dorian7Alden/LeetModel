...
| [knowledge-retrieval-service/](knowledge-retrieval-service/) | 目标独立知识检索服务；版本化 RAG、受控 AI 选文、来源适用性与检索快照 |
...
| [ai-review-service/](ai-review-service/) | 版本化 AI 论文评审；目标新版本强制使用版本化 PDF 解析 |
