...
- 提供题目详情页使用的公开聚合统计：有效参赛队伍数和去重后的有效参赛人数；统计只读且不泄露成员身份。
- 校验队长管理权限、队伍容量和成员关系约束。
- 提供按队伍、题目和招募职位发现缺人队伍的公共查询、按有效队伍数聚合的热门练习题查询、我的队伍查询和队伍成员内部校验能力。
- 维护独立招募位置、入队申请和审核状态。
...
| [队伍查询](队伍查询/README.md) | 按队伍、题目或招募职位发现缺人队伍，查询热门练习题、我的队伍和队伍详情 |
