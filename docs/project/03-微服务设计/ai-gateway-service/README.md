...
> 2026-08-27 发现通用供应商适配、渠道调度、额度和成本治理与成熟开源项目 new-api 存在重复建设。当前已将 new-api 作为独立第三方基础设施加入本地 Docker 环境，但本服务尚未切换调用链，仍保持当前代码行为。阶段性边界见 [`new-api第三方网关集成.md`](../../02-架构设计/new-api第三方网关集成.md)。
