...
> 设计状态：目标设计已确认，已建立可重复的本地 SkyWalking/BanyanDB/Prometheus/Grafana/Alertmanager 版本与 Agent 兼容基线，详见 [可观测性组件基线](可观测性组件基线.md)。13 个当前服务已统一接入 Actuator、Prometheus Registry、健康分组和核心业务/异步指标；环境编排、看板、主动告警、中央日志和中央 audit-service 仍待实施。
