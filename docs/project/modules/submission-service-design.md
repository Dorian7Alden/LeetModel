...
**原因**：惰性失效交互上残留旧授权痕迹，事件通知语义直接、用户感知正确；跨服务通知与项目微服务主线一致，面试可讲同步调用局限与异步事件演进。实现成本可控，不做属于低性价比的取舍。失效后的记录是否物理删除属实现细节，实现时决定。
...
- `docs/project/analysis/paper-review-problem-space.md`：论文评审问题域规划，域 1 状态追踪
- `docs/project/modules/team-service-design.md`：队伍与角色数据来源
- `docs/standards/08-database-spec.md`：表设计规范
