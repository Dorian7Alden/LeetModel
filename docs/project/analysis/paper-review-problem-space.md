...
| common-ai | 不独立部署 | LLM 调用、RAG 检索、Prompt 管理，被 AI 类服务依赖的公共 jar |
...
| 编号 | 问题点 | 状态 | 关联任务 |
|------|--------|------|---------|
| 1-1 ~ 1-9 | 域 1 论文提交 | 已确认 | D-19、D-20、D-21 |
| 2-1、2-6 | 域 2 解析目标与产物 schema | 已确认 | D-22 |
| 2-2 ~ 2-5、2-7、2-8 | 域 2 PDF 解析其余问题 | 待设计 | D-22 |
| 3-2 ~ 3-6 | 域 3 消费端可靠性、幂等、并发、洪峰、状态一致性 | 设计中 | D-23、D-24 |
| 3-1、3-7 | 域 3 生产端可靠性、结果通知 | 待设计 | D-23、D-24 |
| 4-1 | 域 4 状态机设计 | 设计中 | A-06 |
| 4-2、4-3、4-6、4-7、4-8、4-9 | 域 4 工作流编排、一致性、安全、结果规范、失败处理与可见性 | 设计中 | A-06、E-01 ~ E-09 |
| 4-4 | 域 4 打分标准（美赛与国赛两套） | 设计中 | A-06、E-04 |
| 4-5 | 域 4 RAG 参考资料 | 设计中 | C-01 ~ C-09、E-03 |
| 5-1 ~ 5-6 | 域 5 数据结构与存储 | 待设计 | D-20 |
| 6-1 ~ 6-6 | 域 6 历史记录查询 | 待设计 | D-24、D-25 |
| C-5 | 状态单一事实来源 | 设计中 | 贯穿各域 |
| C-1 ~ C-4 | 跨切面其余问题 | 待设计 | 贯穿各域 |

状态取值：待设计、设计中、已确认、已完成。攻破每个域后回到本文档更新状态。
