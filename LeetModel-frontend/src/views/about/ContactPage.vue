<template>
  <div class="contact-page">
    ...
    <el-alert title="当前版本尚未接入站内反馈表单" type="info" :closable="false" show-icon>
      <template #default>我们不会模拟“发送成功”。登录用户可从顶部导航进入 AI 客服查询平台操作；缺陷与建议请通过项目 GitHub 提交。</template>
    </el-alert>
    <div class="info-cards support-grid">
      <div class="info-card">
        <div class="info-icon"><el-icon :size="24"><ChatDotRound /></el-icon></div>
        <div class="info-body"><h4>AI 客服</h4><p><router-link to="/assistant">从顶部导航进入</router-link></p><span class="info-hint">用于平台操作说明与受控选题辅助</span></div>
      </div>
