...
INIT_FILE="${INFRA_SCRIPTS_DIR}/init-rocketmq.sh"
ACL_FILE="${INFRA_SCRIPTS_DIR}/init-audit-rocketmq-acl.sh"
ACL_CONFIG_FILE="${ROCKETMQ_CONFIG_DIR}/broker-acl.conf.example"
