...
PRODUCER="${BACKEND_DIR}/common/common-messaging/src/main/java/com/leetmodel/common/messaging/internal/OperationAuditGovernanceProducer.java"
MESSAGING="${BACKEND_DIR}/common/common-messaging/src/main/java/com/leetmodel/common/messaging/internal/MessagingOperationsService.java"
