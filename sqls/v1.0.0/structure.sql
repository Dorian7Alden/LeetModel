...
CREATE TABLE `user`  (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '用户账号状态：0-未激活 1-正常 2-封禁 3-已注销',
...
CREATE TABLE `tag_category`  (
  ...
  `sort_order` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '排序权重（升序）',
...
CREATE TABLE `problem`  (
  ...
  `problem_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '题目状态：0-草稿 1-已发布 2-已下线 3-已归档',
...
CREATE TABLE `problem_link`  (
  ...
  `sort_order` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '链接展示优先级',
...
CREATE TABLE `tag`  (
  ...
  `sort_order` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '排序权重（升序）',
  `usage_count` int(10) unsigned NOT NULL DEFAULT 0 COMMENT '引用次数（冗余计数）',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：0-禁用 1-启用',
...
CREATE TABLE `role`  (
  `role_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '角色表主键ID',
  `name` varchar(50) NOT NULL COMMENT '角色名称',
  `code` varchar(50) NOT NULL COMMENT '角色编码（唯一标识）',
  `description` varchar(255) NULL DEFAULT NULL COMMENT '角色说明',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：0-禁用 1-启用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '角色记录创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '角色记录更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `permission`  (
  `permission_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '权限表主键ID',
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '权限记录更新时间',
  PRIMARY KEY (`permission_id`) USING BTREE,
  UNIQUE INDEX `uk_permission_code`(`code`) USING BTREE,
  UNIQUE INDEX `uk_permission_name`(`name`) USING BTREE,
  INDEX `idx_permission_status`(`status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_role`  (
  `user_role_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '用户-角色关联表主键ID',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID（关联user.user_id）',
  `role_id` bigint(20) NOT NULL COMMENT '角色ID（关联role.role_id）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '用户-角色关联记录创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '用户-角色关联记录更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户-角色关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `role_permission`  (
  `role_permission_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '角色-权限关联表主键ID',
  `role_id` bigint(20) NOT NULL COMMENT '角色ID（关联role.role_id）',
  `permission_id` bigint(20) NOT NULL COMMENT '权限ID（关联permission.permission_id）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '角色-权限关联记录创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '角色-权限关联记录更新时间',
  PRIMARY KEY (`role_permission_id`) USING BTREE,
  UNIQUE INDEX `uk_role_permission`(`role_id`, `permission_id`) USING BTREE,
  INDEX `idx_role_permission_role_id`(`role_id`) USING BTREE,
  INDEX `idx_role_permission_permission_id`(`permission_id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色-权限关联表' ROW_FORMAT = Dynamic;
